...
export function getTasksForDay(dayIdx: number): {
  ...
  const schedule: ScheduleTask[] = [
    ...
    },
    {
      ...
      sub: isRest ? 'Active recovery · stretch · light walk' : `Complete your ${calDay} circuit (1 hr)`,
    ...
    },
    {
      ...
      sub: isWeekend ? 'Reading · grammar · vocabulary building' : 'Next.js / NestJS / PostgreSQL / TypeORM',
